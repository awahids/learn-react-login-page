...
const Login = () => {
  const google = () => {
    window.open('https://server-learn-react-login.vercel.app/auth/google', '_self');
  };

  const twitter = () => {
    window.open('https://server-learn-react-login.vercel.app//auth/twitter', '_self');
  };

  const github = () => {
    window.open('https://server-learn-react-login.vercel.app//auth/github', '_self');
  };
